...
uv run python scripts/hydra_workflow.py analysis.threshold=0.85 run_name=hydra-variant
uv run python scripts/hydra_workflow.py --multirun analysis.threshold=0.85,0.90,0.95 run_name=hydra-sweep
```
