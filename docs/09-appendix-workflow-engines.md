...
`src/<PROJECT_PACKAGE>/engine_runner.py`
...
from <PROJECT_PACKAGE>.engine_runner import run_once
...
if __name__ == "__main__":
    sample_variants = [
        {"run_name": "engine-demo-a", "overrides": ["analysis.threshold=0.85"]},
        {"run_name": "engine-demo-b", "overrides": ["analysis.threshold=0.90"]},
    ]
